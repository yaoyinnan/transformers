...
from transformers import my_compute_metrics as compute_metrics
from transformers import my_output_modes as output_modes
from transformers import my_processors as processors
from transformers import my_convert_examples_to_features as convert_examples_to_features
...
def load_and_cache_examples(args, task, tokenizer, evaluate="train"):
    ...
    cached_features_file = os.path.join(args.data_dir, 'cached_{}_{}_{}_{}'.format(evaluate,
                                                                                   list(filter(None,
...
def main():
    ...
    parser.add_argument('--predict_file', type=str, help="Path to prediction.")
