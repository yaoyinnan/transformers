...
export TASK_NAME=wuhan2019ncov
...
export STAGE_NUM=1
export NEXT_STAGE_NUM=5

export PRED_BATCH_SIZE=256
...
python ./examples/run_classifier.py \
    ...
    --per_gpu_test_batch_size ${TEST_BATCH_SIZE}   \
    --per_gpu_pred_batch_size ${PRED_BATCH_SIZE}   \
    --learning_rate 5e-5 \
    --weight_decay 0.0001 \
